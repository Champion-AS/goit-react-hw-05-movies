...
export function MovieDetails({ state }) {
    ...
    if (!Object.keys(searchValue).length) {
        return (
            <Container>
                <h2>Oops, something went wront, try again</h2>
                <BackLink to={backLinkHref}>Go back</BackLink>
            </Container>
        )
    }

    const { title, name, overview, release_date, vote_average, genres, poster_path } = searchValue;
    ...
    return (
        <Container>
            ...
            <section className={s.mainSection}>
                <img src={movieAddress} alt="" width={250} />
